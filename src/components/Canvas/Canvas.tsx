...
const Canvas = forwardRef<HTMLCanvasElement, CanvasProps>((
    ...
    useEffect(() => {
        ...
        if (prepullRotation.length > 0 && rotation.length > 0) {
            drawPrepullLine(context, startPoint + prepullWidth + positions.rotationPadding, midLine, pullLabel)
        }
    ...
    }, [width, prepullIcons, rotationIcons, midLine, startPoint, prepullRotation.length, rotation.length, prepullWidth, screenWidth, jobIcon, title, jobName, level, expansion, patch, canvasWidth, buffLineHeight, useBalanceLogo, pullLabel, levelPrefix, patchLabel])
